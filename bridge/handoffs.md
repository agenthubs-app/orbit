...
| --- | --- | --- | --- | --- | --- |
| [BR-026](2026-09-16-cloud-five-item-acceptance.md) | P1 | 五项云端闭环：生命周期、提醒、worker、原生、新用户 | consumer_ready | Bridge；模型预算/兼容原生工具链待决定 | 实际生成→发布→参与者回读，以及 Production 原生双向同记录和完整新用户流程 |

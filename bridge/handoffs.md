...
| --- | --- | --- | --- | --- | --- |
| [BR-026](2026-09-16-cloud-five-item-acceptance.md) | P1 | 五项云端闭环：生命周期、提醒、worker、原生、新用户 | consumer_ready | 活动参会者/交换原生详情、pending真实正例、服务端legacy状态边界 | Xcode27签名原生＋Production双向待办/日程、关系完成下一步、冷读/换号隔离已验；App3af3eefe/5ac0e9fd，旧canonical入口实际复验。活动详情链缺口、pending新对象/模型预算范围未确认，整体未关闭 |

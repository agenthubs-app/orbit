...
| `web:/app/events/[id]` | web | production | `/app/events/[id]` | `web:/app/events` | id | 2 | 82 | 25 | runtime-partially-verified-web-public-event-detail-lifecycle |
| `web:/app/events/[id]/register` | web | production | `/app/events/[id]/register` | `web:/app/events/[id]` | id | 1 | 25 | 5 | runtime-partially-verified-live-event-registration |

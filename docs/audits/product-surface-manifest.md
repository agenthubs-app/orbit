...
- Schema: 2
- Indexed commit: `72bedab578efd73f35e7b27db23edb3bb8d94097`
- Deterministic generated timestamp (commit time): 2026-07-29T05:53:23+09:00
...
| --- | --- | --- | --- | ---: | ---: | ---: |
| `/app/account/forgot-password` | Password recovery | public-auth-entry | Live, Mock, Derived, User Confirmed | 13 | 2 | 0 |
| `/app/account/login` | User sign in | public-auth-entry | Live, Mock, Derived, User Confirmed | 13 | 21 | 0 |
| `/app/account/mobile-google` | Mobile Google authentication completion | public-auth-entry | Live, Mock, Derived, User Confirmed | 2 | 3 | 0 |
| `/app/account/signup` | User account creation | public-auth-entry | Live, Mock, Derived, User Confirmed | 13 | 13 | 0 |
| `/app/admin/access` | Admin access entry | public-at-proxy | Live, Mock, Fixture, Derived, User Confirmed | 5 | 30 | 0 |
...
| `/app/contacts/dashboard` | Relationship analytics dashboard | authenticated | Live, Mock, Fixture, Derived, AI Generated, User Confirmed, Externally Executed | 46 | 29 | 0 |
...
| `/app/dashboard` | Relationship dashboard | authenticated | Live, Mock, Fixture, Derived, AI Generated, User Confirmed | 41 | 29 | 0 |
...
| `/app/today` | Today timeline and action review | authenticated | Live, Mock, Fixture, Derived, AI Generated, User Confirmed, Externally Executed | 63 | 28 | 0 |

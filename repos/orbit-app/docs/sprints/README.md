...
| [0052](0052-needs-evidence-ranking/GOAL.md) | 需求匹配显示简短可核对的真实依据，评分体现业务场景和实际能力而非泛AI词 | 2026-09-16用户匹配短句和分数改进要求，Phone父只读诊断/冻结契约222ab259 | ROOT登记唯一A现有任务01a0a879-e923-7701-8e39-935f36eab448，GPT-5.6 Sol medium，独立树.worktrees/sprint-0052-needs-evidence-ranking，分支codex/sprint-0052-needs-evidence-ranking，固定f4e1059a596ec18305c13490e240e2440e81a604，run-01=1；既有A PW原run已由父正式closed、旧树untracked报告保留。目标/契约/四字典无并写，A独占本算法及消费者/字典，源锁释放前其他线不并改；SC05实际服务由ROOT/Phone父后续协调，目前无v2实现或验收声明 | running |
...
| [0054](0054-personal-schedule-display-correctness/GOAL.md) | 修正个人日程原生分钟单位和全天占用日期，UTC/编辑语义不变 | 0053真实Hermes显示秒及全天多一天；承接SC01/02/05，窄范围不重开旧run | 唯一B任务01a0a879-e8fe-77e3-b748-bd78005aecc8，GPT-5.6 Sol medium；独立.worktrees/sprint-0054-personal-schedule-display-correctness，分支codex/sprint-0054-personal-schedule-display-correctness；固定1bc3b13c8，Planner f593452f543d13dc61f5c68dc906126c6197099b709b55da74a7b2bd10c58434，run-01=1。先只读/基线核验，ROOT索引刷新中不访问graph，actual impact后才能改详情/阅读VM及测试；不改0052四字典/契约或操作真实服务/账号，无修复声明 | running |

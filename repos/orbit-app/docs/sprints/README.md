...
| [0032](0032-hybrid-sync-foundation/GOAL.md) | 建立云端权威、加密且按账号隔离的 App 本地实体镜像 | 用户批准“云端权威＋本地持久镜像＋增量同步”方案 | run-01 本线验收通过；功能 `0c1cf70bb`，App 139/139、Web 8/8、两端 typecheck、SQLCipher 原生构建与 Simulator 重启／登出／隔离通过；待协调者固定最终 SHA、merge 与精确合并树复验，见 [REPORT](0032-hybrid-sync-foundation/REPORT.md) | running |

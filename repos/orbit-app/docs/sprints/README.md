...
| [0033](0033-incremental-read-sync/GOAL.md) | 首次分页同步，之后只拉取笔记、待办、跟进和个人日程的变化与删除 | 同上；减少重复上传下载的读取阶段 | run-01，基线 `a8ac3f761`；已修订 envelope/workspace/task projection/reset/migration 契约，Task 1 RED 进行中 | running |

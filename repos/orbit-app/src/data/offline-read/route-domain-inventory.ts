...
const surfaceKeys: readonly SurfaceKey[] = [
  ...
  ["src/screens/ai/ContactMentionPicker.tsx","GET","/api/contacts/page"],
  ["src/screens/ai/ContactReferenceChip.tsx","GET","/api/contacts/:id"],
  ...
  ["src/screens/contacts/ContactIntrosScreen.tsx","GET","/api/contacts/intros/summary"],
  ...
  ["src/hooks/useContactPipelinePages.ts","GET","/api/contacts/pipeline"],
  ...
  ["src/screens/profile/ProfileScreen.tsx","GET","/api/contacts/summary"],
  ...
  ["src/screens/profile/ProfileScreen.tsx","GET","/api/tasks/page"],
  ...
  ["src/screens/tasks/RelationshipTaskTools.tsx","GET","/api/inbox/notifications"],

...
const useStyles = createThemedStyles(colors => StyleSheet.create({
  ...
  field: { color: colors.ink, flex: 1, fontSize: 16, fontWeight: "800", lineHeight: 23 },
  status: { color: colors.accent, fontSize: 12, fontWeight: "700", lineHeight: 18 },
  source: { color: colors.text4, fontSize: 12, lineHeight: 18 },
  diff: { backgroundColor: colors.surface2, borderColor: colors.border, borderRadius: 8, borderWidth: 1, gap: 5, padding: 12 },
  diffLabel: { color: colors.text4, fontSize: 11, fontWeight: "700", lineHeight: 17 },
  value: { color: colors.text3, fontSize: 14, lineHeight: 21 },
  strongValue: { color: colors.ink, fontSize: 14, fontWeight: "700", lineHeight: 21 },
  rationale: { color: colors.text, fontSize: 13, lineHeight: 20 },
  evidence: { color: colors.text4, fontSize: 12, lineHeight: 18 },
  ...
  acceptText: { color: colors.onAccent, fontSize: 13, fontWeight: "800", lineHeight: 19 },
  ...
  dismissText: { color: colors.ink, fontSize: 13, fontWeight: "700", lineHeight: 19 },

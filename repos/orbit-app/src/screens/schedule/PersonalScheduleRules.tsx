...
import { KeyboardAvoidingView, Modal, PanResponder, Platform, Pressable, ScrollView, Text, TextInput, View } from "react-native";
import { useOrbitLocale } from "../../i18n/OrbitLocaleContext";
import { createThemedStyles } from "../../design/theme";
import type { PersonalScheduleDraft } from "../../view-models/personal-schedule-editor";

export function PersonalScheduleRules({ draft, disabled = false, readOnly = false, reminderElapsed = false, onChange, scope }: { draft: PersonalScheduleDraft; disabled?: boolean; readOnly?: boolean; reminderElapsed?: boolean; onChange?: (draft: PersonalScheduleDraft) => void; scope?: { selected: "occurrence" | "series" | null; isOccurrence: boolean; onSelect(value: "occurrence" | "series"): void } }) {
  ...
  return <View>
    ...
    <Modal visible={open !== null} transparent animationType="slide" onRequestClose={close}>
      <KeyboardAvoidingView behavior={Platform.OS === "ios" ? "padding" : undefined} style={styles.overlay}>
        <Pressable accessibilityRole="button" accessibilityLabel={locale.t("common.close")} onPress={close} style={styles.backdrop} />
        <View role="dialog" accessibilityLabel={title} accessibilityViewIsModal style={styles.sheet}>

...
- Recommendations and event workflow: `features/recommendations/service.ts`, `features/events/service.ts`, and future event roster, recommendation, and opening-line provider adapters under `features/events/providers/` and `features/recommendations/providers/`.

...
- 2026-09-09 11:38Z 复查：链自 09-08 02:25Z 启动后仍以约 10 分钟间隔调用 `/api/queues/maintenance`（最近 11:33:48Z，`maintenance_pass` 单次约 6 秒），连续自转已超过 33 小时且未经人工干预；跨部署（新部署后旧链是否被新链替换）与消息保留 7 天的行为仍待观察。

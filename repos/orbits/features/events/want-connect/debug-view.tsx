...
import { createMockWantConnectService } from "./mock-service";
...
const liveHandoffEvidenceExcerpts = [
  "Live service files live under features/events/want-connect/.",

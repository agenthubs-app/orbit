...
export const WANT_CONNECT_ERROR_CODES = [
  ...
  "WANT_CONNECT_LIVE_STORE_UNCONFIGURED",
] as const;
...
export const WANT_CONNECT_ERROR_DEFINITIONS = {
  ...
  WANT_CONNECT_LIVE_STORE_UNCONFIGURED: {
    code: "WANT_CONNECT_LIVE_STORE_UNCONFIGURED",
    appCode: "SERVICE_UNAVAILABLE",
    message: "The live want-connect store is not configured.",
    recovery:
      "Configure ORBIT_EVENT_DATABASE_URL, ORBIT_LIVE_DATABASE_URL, or ORBIT_DATABASE_URL before using live want-connect records.",
  },
...
export type WantConnectServiceResult<TResult> = TResult | Promise<TResult>;

export interface WantConnectService {
  createWantToConnectIntent: (
    input?: WantConnectIntentInput,
  ) => WantConnectServiceResult<WantConnectResult>;
  listMatches: (
    input?: WantConnectMatchesInput,
  ) => WantConnectServiceResult<WantConnectMatchesResult>;
}

...
import { createMockEventEncounterNoteService } from "./mock-service";
...
const liveHandoffEvidenceExcerpts = [
  "Live service files live under features/events/encounter-note/.",

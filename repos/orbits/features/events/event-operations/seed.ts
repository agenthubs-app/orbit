...
export const EVENT_OPERATIONS_E2E_PARTICIPANTS = [
  ...
  participant(19, "Mei Lin", "Design research director @ HumanSignal", "Product design", "AI product leads, accessibility experts", "A multilingual research panel and inclusive interview playbooks for complex AI workflows", "Find one team willing to co-design an accessible agent onboarding study", "Patient interviewer", "Led mixed-method research that changed the navigation model of a product used by 80,000 people", "中文, English, 日本語, Prefer a research brief followed by a 45-minute working session"),
  participant(20, "Akira Fujimoto", "Policy counsel @ CivicStack", "Technology policy", "AI builders, public-sector buyers", "Practical policy-to-product control maps and public procurement review experience", "Translate regulation into product controls", "Evidence-first debater", "Helped a civic AI program pass independent review across privacy, procurement, and model governance", "日本語, English, Send a concise risk register before arranging a policy review"),
  participant(21, "Grace Kim", "Revenue operations VP @ AtlasCloud", "B2B SaaS", "Founders and operators redesigning enterprise sales systems", "Revenue system design and benchmark data from multi-region go-to-market teams", "Compare evidence-based approaches to reducing handoff loss between product, sales, and success", "Analytical facilitator who likes mapping decisions on a shared board", "Rebuilt forecasting and territory operations for a SaaS company growing from 40 to 180 sellers", "English, 한국어, Follow up with a process map and one measurable experiment"),
  participant(22, "Mateo Silva", "Biodiversity founder @ CanopyTrace", "Nature technology", "Satellite teams, consumer brands", "Field-calibrated biodiversity baselines and supplier engagement methods", "Secure one consumer-brand partner for a transparent habitat monitoring pilot", "Mission-led storyteller", "Coordinated ecological surveys across 140 farms and translated the results into procurement decisions", "Português, English, Prefer a pilot hypothesis and named data owner within one week"),
  participant(23, "Hana Suzuki", "Customer success lead @ CareBridge", "Digital health services", "Care providers, patient communication teams, privacy-aware product leaders", "Retention diagnostics and frontline onboarding playbooks from hospital deployments", "Co-design a low-burden adoption program for care teams using a new digital workflow", "Calm listener who draws out operational details before suggesting changes", "Improved ninety-day clinical-team adoption from 54% to 82% across twelve care sites", "日本語, Prefer a short written recap and an on-site workflow review"),
  participant(24, "Noah Bennett", "Repeat founder @ QuietCurrent", "Founder operations", "Early-stage founders, product strategists, patient seed investors", "Lessons from two venture outcomes and a disciplined approach to low-burn validation", "Find a collaborator for a small, evidence-led product discovery sprint", "Low-key contrarian who prefers candid one-to-one discussion", "Built and sold a workflow product after reaching profitability with a team of nine", "English, Send the sharpest open question first; schedule only if both sides can contribute"),
  ...
  // These twelve round out the fixed matching cohort with complete, diverse
  // profiles so every matching dimension is real evidence rather than an
  // empty placeholder.
  ...
  participant(59, "Kaito Mori", "Publishing partnerships manager @ Lantern Games", "Interactive entertainment", "Independent studios, localization producers, community safety leads", "Console publishing experience and relationships with Japanese localization teams", "Explore responsible market entry for a cooperative narrative game", "Curious and informal in small groups", "Coordinated launches for five independent titles across East Asia", "日本語, English, Prefer a playable build and localization scope before a commercial call"),
  participant(60, "Isabel Costa", "Research fellow @ BioWeave Lab", "Biomaterials", "Packaging engineers, fermentation scale-up teams", "Bench samples of a seaweed-based barrier coating", "Find an industrial partner to validate shelf-life performance", "Quiet experimentalist", "Designed a moisture-barrier formulation that extended fresh-food shelf life by nine days in lab trials", "Português, English, Exchange test protocols first and review results in a technical session"),
  participant(61, "Rohan Gupta", "Revenue AI product lead @ ClearQuota", "B2B software", "Sales operations leaders, responsible AI reviewers", "Workflow prototypes for evidence-linked account planning", "Validate whether transparent recommendations improve seller trust and forecast quality", "Structured challenger", "Led deployment of an account-planning assistant across 600 sellers with auditable evidence links", "English, हिन्दी, Prefer a red-team review followed by a tightly scoped design-partner trial"),
  participant(62, "Eri Nishida", "Independent curator @ Field Notes Tokyo", "Arts and culture", "Community venue operators, cultural funders", "Curatorial experience with neighborhood archives", "Build a shared exhibition format that returns useful digital records to participating communities", "Reflective listener", "Produced seven resident-led archive exhibitions across neighborhoods facing rapid redevelopment", "日本語, Prefer an in-person site walk and a visual one-page concept afterward"),
  participant(63, "Binta Diop", "SME finance analyst @ Teranga Cooperative", "Inclusive finance", "Cooperative lenders, cash-flow data teams, women-led export businesses", "Credit analysis grounded in seasonal cash flow and cooperative governance", "Design a fair working-capital pilot for small exporters with irregular payment cycles", "Trust-first listener who asks detailed questions about incentives and repayment pressure", "Evaluated 320 small-business facilities while maintaining portfolio arrears below the regional benchmark", "Français, English, Follow up through a cooperative introduction with transparent pricing assumptions"),
  participant(64, "Théo Martin", "Spatial audio designer @ Resonant Room", "Immersive media", "Museum producers, accessibility researchers, game audio teams", "Portable spatial-audio prototypes and inclusive listening-session methods", "Find a cultural venue for an accessible multisensory storytelling pilot", "Playful prototyper who communicates through rapid sound demonstrations", "Designed award-nominated interactive soundscapes for three museums and two narrative games", "Français, English, Share a floor plan and audience needs before scheduling a studio demo"),

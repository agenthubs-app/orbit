/**
 * 活动目标与 readiness mock 的开发者面板。
 *
 * 面板展示活动目标、准备清单和建议，帮助验证活动前准备工作流。
 */
import {
  Chip,
  Field,
...
import { createMockEventGoalAndReadinessService } from "./mock-service";
...
const liveHandoffEvidenceExcerpts = [
  "Live service files live under features/events/goal-readiness/.",

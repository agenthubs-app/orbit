...
export const EVENT_ATTENDEE_ROSTER_ERROR_DEFINITIONS = {
  ...
  EVENT_ATTENDEE_ROSTER_LIVE_STORE_UNCONFIGURED: {
    code: "EVENT_ATTENDEE_ROSTER_LIVE_STORE_UNCONFIGURED",
    appCode: "SERVICE_UNAVAILABLE",
    message: "The live attendee roster store is not configured.",
    recovery:
      "Configure ORBIT_EVENT_DATABASE_URL, ORBIT_LIVE_DATABASE_URL, or ORBIT_DATABASE_URL before using live attendee rosters.",
  },
...
export type EventAttendeeRosterServiceResult<TResult> = TResult | Promise<TResult>;

export interface EventAttendeeRosterService {
  getAttendeeRoster: (
    input?: EventAttendeeRosterInput,
  ) => EventAttendeeRosterServiceResult<EventAttendeeRosterResult>;
  importAttendeeRoster: (
    input?: EventAttendeeRosterInput,
  ) => EventAttendeeRosterServiceResult<EventAttendeeRosterImportResult>;
}

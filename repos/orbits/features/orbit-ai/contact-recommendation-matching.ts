...
function candidateFor(item: RelationshipNaturalSearchResultItem): ContactRecommendationCandidate | null {
...
export function createRuleBasedContactRecommendationMatcher(input: {
  ...
  const relationshipSearchService =
    input.relationshipSearchService ?? createRelationshipNaturalSearchService();

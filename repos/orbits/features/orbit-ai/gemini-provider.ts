...
function entityDraftInstruction(): string {
  return [
    ...
    "Required fields: task needs title; note needs title; schedule needs title and startsAt; event needs title and startsAt.",
    "For an event, also return sourceNote: one sentence on why this event belongs in Orbit, taken from what the user said.",
    "Optional fields: task dueAt/notes/category, note body, schedule endsAt/location, event endsAt/location/description.",

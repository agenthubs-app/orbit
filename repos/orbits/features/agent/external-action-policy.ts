...
export const externalActionSandboxProvenance: ExternalActionSandboxProvenance =
  {
...
export const externalActionSandboxNoOpProvenance: ExternalActionSandboxProvenance =
  {
    ...externalActionSandboxProvenance,
...
export const externalActionSandboxFailureProvenance: ExternalActionSandboxProvenance =
  {
    ...externalActionSandboxProvenance,
...
export const externalActionRelationshipContexts = {
  send_message: {
...
export const externalActionSandboxActions: readonly ExternalActionSandboxAction[] =
  [
    {
      ...
      relationshipContext: externalActionRelationshipContexts.send_message,
    ...
    },
    {
      ...
      relationshipContext:
        externalActionRelationshipContexts.create_calendar_event,
    ...
    },
    {
      ...
      relationshipContext:
        externalActionRelationshipContexts.deliver_notification,
...
function auditRecord(
  ...
  return {
    ...
    provenance: externalActionSandboxNoOpProvenance,
  };
}

export const externalActionAuditRecords: readonly ExternalActionAuditRecord[] =
  [
    auditRecord(
      externalActionSandboxActions[0],
      "audit:external-action:message:maya-chen",
    ),
    auditRecord(
      externalActionSandboxActions[1],
      "audit:external-action:calendar:diego-rivera",
    ),
    auditRecord(
      externalActionSandboxActions[2],
...
export const sendMessageNoOpFixture: ExternalActionNoOpPayload = noOpPayload(
  externalActionSandboxActions[0],
  externalActionAuditRecords[0],
);

export const createCalendarEventNoOpFixture: ExternalActionNoOpPayload =
  noOpPayload(externalActionSandboxActions[1], externalActionAuditRecords[1]);

export const notificationDeliveryNoOpFixture: ExternalActionNoOpPayload =
  noOpPayload(externalActionSandboxActions[2], externalActionAuditRecords[2]);

export const externalActionSandboxFixture: ExternalActionSandboxPayload = {
  state: "success",
  actions: externalActionSandboxActions,
  auditRecords: externalActionAuditRecords,
  summary:
...
export const emptyExternalActionAuditFixture: ExternalActionSandboxPayload = {
  state: "empty",
  actions: [],
  auditRecords: [],
  summary:
...
export const pendingExternalActionSandboxFixture: ExternalActionSandboxPayload =
  {
    state: "pending",
    actions: [],
    auditRecords: [],

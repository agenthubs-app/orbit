...
export const agentAutonomySettingsProvenance: AgentAutonomySettingsProvenance =
  {
...
export const agentAutonomySettingsFailureProvenance: AgentAutonomySettingsProvenance =
  {
    ...agentAutonomySettingsProvenance,
...
export const agentAutonomyLevels: readonly AgentAutonomyLevelBoundary[] = [
  {
    level: "low",
    label: "Low autonomy",
    boundary:
...
export const agentAutonomyConfirmationRules: readonly AgentAutonomyConfirmationRule[] =
  [
    {
...
export const agentAutonomyRelationshipWorkflowProtections: readonly AgentAutonomyRelationshipWorkflowProtection[] =
  [
    {
...
export const agentAutonomySettingsFixture: AgentAutonomySettingsPayload = {
  state: "success",
  currentLevel: "medium",
  levels: agentAutonomyLevels,
  confirmationRules: agentAutonomyConfirmationRules,
  relationshipWorkflowProtections: agentAutonomyRelationshipWorkflowProtections,
  summary:
...
export const emptyAgentAutonomySettingsFixture: AgentAutonomySettingsPayload = {
  state: "empty",
  currentLevel: null,
  levels: [],
  confirmationRules: [],
  relationshipWorkflowProtections: [],
  summary: "No local mock autonomy setting has been selected for this scenario.",
  provenance: emptyStateProvenance,
  nextAction:
    "Choose an autonomy level before staging any agent setting in the mock boundary.",
};

export const pendingAgentAutonomySettingsFixture: AgentAutonomySettingsPayload = {
  state: "pending",
  currentLevel: "medium",
  levels: agentAutonomyLevels,
  confirmationRules: agentAutonomyConfirmationRules,
...
function levelBoundary(level: AgentAutonomyLevel): AgentAutonomyLevelBoundary {
  return agentAutonomyLevels.find((candidate) => candidate.level === level)!;
}
...
export const updatedLowAgentAutonomySettingsFixture = updateFixture(
  "low",
  "Mock operator",
  "Low autonomy saved locally; all external actions stay blocked and every relationship step remains manual.",
);

export const updatedMediumAgentAutonomySettingsFixture = updateFixture(
  "medium",
  "Mock operator",
...
export const updatedHighAgentAutonomySettingsFixture = updateFixture(
  "high",
  "Sprint evaluator",

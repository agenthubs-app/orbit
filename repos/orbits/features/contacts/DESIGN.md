...
契约位于 `features/contacts/contract.ts`。核心 DTO 包括 contact summary、contact detail、source labels、value tags、status、next action 和 provenance。Contacts 不应暴露搜索索引 raw query、数据库 row 或外部 CRM payload。

...
async function mountPage(t: any, deferSaves = false) {
  ...
  t.mock.method(globalThis, "fetch", async (input: string, init?: RequestInit) => {
    ...
    if (path === "/api/ai/conversations") return Response.json({ success: true, data: { assistantMessage: "可以加入待办。", taskInteraction: suggestion, artifacts: [] } });

...
export function resolveOrbitAppRoute(pathname: string | null): OrbitAppRoute {
  return pathname && routeSet.has(pathname) ? (pathname as OrbitAppRoute) : "/app";
}
...
.orbit-app-shell-ai-command .orbit-bottom-navigation {
  margin-inline: auto;
  max-width: 980px;
  opacity: 0.78;
}

.orbit-app-shell-ai-command .orbit-bottom-navigation .orbit-chip {
  ...
  return (
    ...
    >
      ...
      <div className="workbench-shell">
        ...
        <section aria-label="Active Orbit route">{children}</section>

        {deferredWorkspaceActions.length > 0 && (
          <div

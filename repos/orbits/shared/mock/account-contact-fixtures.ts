...
import type { ConnectionDTO, ContactDTO, RelationshipEvidenceDTO } from "../domain/contracts";
...
const fixtures: readonly FixtureDefinition[] = [
  ...
  },
  {
    ...
    secondaryIndustryId: "retail_consumer.ecommerce",
  ...
  },
  {
    ...
    industry: "云基础设施",
    primaryIndustryId: "technology_internet",
    secondaryIndustryId: "technology_internet.cloud_infrastructure",
  ...
  },
  {
    ...
    secondaryIndustryId: "media_creative.advertising_marketing",
  ...
  },
  {
    ...
    secondaryIndustryId: "food_hospitality.hotels_tourism",
...
export function buildAccountContactFixtures(accountId: string) {
  ...
  return fixtures.map((fixture, index) => {
    ...
    const contact: ContactDTO = {
      ...
      ...(fixture.secondaryIndustryId ? { secondaryIndustryId: fixture.secondaryIndustryId } : {}),
      stage: fixture.stage,
    ...
    return { sourceIndex: index, fixture, contact, connection, evidenceRecords };
  });
}

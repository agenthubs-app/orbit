...
export const PARTY_CONTENT: PartyContent = {
  ...
  me: {
    ...
    seat: "C1",
    role: {
      en: "AI & Computer Vision Engineer, OPPO Japan Research",
      ja: "AI・CVエンジニア、OPPO日本研究所",
      zh: "AI 与计算机视觉工程师，OPPO 日本研究所",
    },
    offering: [
      {
        en: "Production ML: quantization, on-device latency, C++ SDK",
        ja: "量産ML：量子化・端末レイテンシ・C++ SDK",
        zh: "量产级 ML：量化、端侧延迟、C++ SDK",
      },
      {
        en: "Camera AI / HDR / CV algorithms (10M+ devices)",
        ja: "カメラAI・HDR・CV（1000万台以上に搭載）",
        zh: "相机 AI / HDR / CV 算法（千万级出货）",
      },
      {
        en: "Trustworthy LLM & RAG systems",
        ja: "信頼できるLLM・RAGの構築",
        zh: "可信 LLM 与 RAG 系统",
      },
    ],
    seeking: [
      {
        en: "Trustworthy GenAI / LLM application opportunities",
        ja: "信頼できる生成AI／LLM応用の機会",
        zh: "可信生成式 AI / LLM 应用的落地机会",
      },
      {
        en: "Teams shipping AI to production",
        ja: "AIを本番投入するチーム",
        zh: "把 AI 真正落地到生产的团队",
      },
      {
        en: "AI product collaborations in Japan",
        ja: "日本でのAIプロダクト協業",
        zh: "在日本的 AI 产品合作",
      },
    ],
    topics: [
      ...
      {
        en: "RAG & evidence-grounded AI",
        ja: "RAG・根拠付きAI",
        zh: "RAG 与有据可循的 AI",
      },
      {
        en: "Computer Vision / HDR",
        ja: "コンピュータビジョン・HDR",
        zh: "计算机视觉 / HDR",
      },
    ],
    prompts: [
      {
        en: "I took HDR camera AI to 10M+ devices and now build evidence-grounded GenAI. What's your hardest 'ship it to production' AI problem?",
        ja: "HDRカメラAIを1000万台以上へ量産し、今は根拠付き生成AIを作っています。あなたの一番難しい『本番投入』のAI課題は？",
        zh: "我把 HDR 相机 AI 做到千万级出货，现在在做有据可循的生成式 AI。你最难的『把 AI 落地到生产』的问题是什么？",
      },
      {
        en: "Do you make your LLM answer only when it has evidence — and stay silent when it doesn't?",
        ja: "LLMを『根拠がある時だけ答え、無い時は黙る』設計にしていますか？",
        zh: "你会让 LLM『只在有依据时才回答、没有依据就保持沉默』吗？",
      },
    ],
  },
  recommendations: [

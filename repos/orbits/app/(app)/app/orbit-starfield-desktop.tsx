    ...
    <div className="sk-home-desktop">
      ...
      <div ref={hostRef} id="skRoot" style={{"fontFamily":"'Noto Sans SC',system-ui,-apple-system,sans-serif","color":"#eceaf6","background":"#06050d","position":"fixed","inset":"0","overflow":"hidden"}} data-screen-label="iOrbit 星空旅程">
        ...
        <div id="skUI" style={{"position":"absolute","inset":"0","zIndex":"5","pointerEvents":"none"}}>
          ...
          {' '}
          <div id="skFieldWrap" style={{"position":"absolute","bottom":"14vh","left":"50%","transform":"translateX(-50%)","width":"min(620px,92vw)","textAlign":"center","opacity":"0","zIndex":"20"}}>
            {' '}
            ...
            <div id="skPromptScope" data-i18n="promptScope" role="status" aria-live="polite" style={{"marginTop":"10px","fontSize":"12px","lineHeight":"1.5","color":"#c4c0d8","pointerEvents":"auto"}}>
              {"示例只会填入输入框，不会自动执行。"}
            </div>
            {' '}
          </div>

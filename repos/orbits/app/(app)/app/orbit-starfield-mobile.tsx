    ...
    <div className="sk-home-mobile">
      ...
      <div ref={hostRef} id="skRoot" style={{"fontFamily":"'Noto Sans SC',system-ui,-apple-system,sans-serif","color":"#eceaf6","background":"#06050d","position":"fixed","inset":"0","overflow":"hidden"}} data-screen-label="iOrbit 移动端">
        ...
        <div id="skMenu" style={{"position":"absolute","top":"62px","right":"16px","zIndex":"70","display":"none","flexDirection":"column","minWidth":"150px","padding":"8px","borderRadius":"16px","background":"rgba(14,12,24,0.95)","border":"1px solid rgba(150,145,200,0.18)","backdropFilter":"blur(18px)","WebkitBackdropFilter":"blur(18px)","boxShadow":"0 22px 54px -22px rgba(0,0,0,0.85)","pointerEvents":"auto"}}>
          ...
          {' '}
          <a href="/app/home/events" data-i18n="navSchedule" style={{"padding":"11px 14px","borderRadius":"10px","fontSize":"14.5px","textDecoration":"none","color":"rgba(236,234,248,0.86)"}} style-hover="background:rgba(139,123,240,0.14);color:#fff;">
            {"日程"}
          </a>
          {' '}
          ...
          <div id="skFieldWrap" style={{"position":"absolute","bottom":"15%","left":"50%","transform":"translateX(-50%)","width":"88%","textAlign":"center","opacity":"0"}}>
            ...
            <div style={{"position":"relative"}}>
              ...
              <div id="skField" style={{"position":"relative","display":"flex","alignItems":"center","gap":"8px","background":"rgba(255,255,255,0.035)","border":"1px solid rgba(150,145,200,0.15)","borderRadius":"14px","padding":"8px 8px 8px 15px","backdropFilter":"blur(16px)","WebkitBackdropFilter":"blur(16px)","boxShadow":"0 0 60px -26px rgba(120,108,240,0.5),inset 0 1px 0 rgba(255,255,255,0.05)"}}>
                ...
                {' '}
                <div style={{"flex":"1","minWidth":"0","textAlign":"left","fontSize":"14.5px","lineHeight":"1.4","color":"#eeecf7","whiteSpace":"nowrap","overflow":"hidden"}}>
                  <span id="skTyped">
                  </span>

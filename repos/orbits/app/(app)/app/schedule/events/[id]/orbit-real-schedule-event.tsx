...
import type { AppScheduleEventPreviewRouteViewModel } from "./event-preview-route-view-model";
...
export function OrbitRealScheduleEvent({
  model,
}: {
  model: AppScheduleEventPreviewRouteViewModel;
}) {

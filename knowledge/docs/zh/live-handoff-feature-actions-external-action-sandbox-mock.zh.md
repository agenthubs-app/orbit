# actions 能力 Live 交接：external action sandbox mock
...
| 中文镜像 | `knowledge/docs/zh/live-handoff-feature-actions-external-action-sandbox-mock.zh.md` |
...
记录 actions 模块中 external action sandbox mock 能力从 mock-first 实现切换到 live provider 时需要替换和验证的边界。

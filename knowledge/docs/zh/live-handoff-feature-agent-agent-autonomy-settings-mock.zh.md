# agent 能力 Live 交接：agent autonomy settings mock
...
| 中文镜像 | `knowledge/docs/zh/live-handoff-feature-agent-agent-autonomy-settings-mock.zh.md` |
...
记录 agent 模块中 agent autonomy settings mock 能力从 mock-first 实现切换到 live provider 时需要替换和验证的边界。

...
| 字段 | 内容 |
| --- | --- |
| 原始来源 | `repos/orbits/docs/superpowers/specs/2026-07-01-live-data-feature-roadmap.md` |
| 中文镜像 | `knowledge/docs/zh/live-data-feature-roadmap.zh.md` |
| 分类 | `sprint-spec` |
| 状态 | `current` |
| 新鲜度 | `likely-current` |
| 负责人域 | `data` |
...
从 mock-first/hybrid 迁移到 orbit_records 远程 live 存储的总路线图：按目标（fixture 种子、各 feature live provider、各 /app/* 路由 live service bundle 等）逐条列出成功证据与实现证据，并记录共享配置化 Postgres 连接池复用、fail-closed 等运行约束；是 live 化工作的 primary source of truth。

## 审计依据

当前权威的滚动路线图文档，随每个 goal 完成持续更新；各条实现证据是当时快照，具体行为以 repos/orbits/shared/storage/ 与各 features/*/live-service、tests/capabilities|pages 下的对应测试为准。

## 结构化阅读入口

- 第 1 节：Orbit Live 数据 Feature Roadmap
- 第 2 节：上下文
- 第 3 节：当前 状态
- 第 4 节：源标题：Roadmap
- 第 5 节：目标 1: Seed All Generated 关系 Fixtures Into 远端 Live DB
- 第 6 节：目标 2: 联系人 Live Provider
- 第 7 节：目标 3: Connections 和 Evidence Live Provider
- 第 8 节：目标 4: Attendees 和 获取 Live Provider
- 第 9 节：目标 5: 搜索 Live Backend
- 第 10 节：目标 6: Orbit AI Tool 集成
- 第 11 节：目标 7: Dashboard, 跟进, 和 任务 Live Provider
- 第 12 节：目标 8: Profile Live Provider
- 第 13 节：目标 9: Profile Signal Review Live Provider
- 第 14 节：目标 10: 关系 Value Scoring Live Provider
- 第 15 节：目标 11: Agent Action Queue Live Provider
- 第 16 节：目标 12: Reminder Schedule 通知 Live Provider
- 第 17 节：目标 13: 能力 Registry Live Inventory Alignment
- 第 18 节：目标 14: Chat Conversation Message Live Provider
- 第 19 节：目标 15: Chat 摘要 Extraction Live Provider
- 第 20 节：目标 16: Chat Writing Assist Live Provider
- 第 21 节：目标 17: Chat Privacy Controls Live Provider
- 第 22 节：目标 18: App Chat 页面 Live 服务 Bundle
- 第 23 节：目标 19: App 联系人 页面 Live 服务 Bundle
- 第 24 节：目标 20: Message Draft 生成器 Live 规则
- 第 25 节：目标 21: App 跟进 页面 Live 服务 Bundle
- 第 26 节：目标 22: Source Consistency Provenance 审计 Live Store
- 第 27 节：目标 23: App Dashboard 页面 Live 服务 Bundle
- 第 28 节：目标 24: App Agent 页面 Live 服务 Bundle
- 第 29 节：目标 25: App 活动 页面 Live 服务 Bundle
- 第 30 节：目标 26: App Profile 页面 Live 服务 Bundle
- 第 31 节：目标 27: Orbit AI Command 和 Proactive Live Policy Providers
- 第 32 节：目标 28: Account Live Storage Session 边界
- 第 33 节：目标 29: 权限 Live Storage Staged Authorization 边界
- 第 34 节：目标 30: App Bootstrap Live Storage First Screen Aggregate
- 第 35 节：目标 31: 联系人 获取 Draft Live Storage 边界
- 第 36 节：目标 32: 手动 联系人 Creation Live Draft Writes
- 第 37 节：目标 33: Duplicate 检测 和 Merge Live Review 边界
- 第 38 节：目标 34: Referral 推荐 Live Review 边界
- 第 39 节：目标 35: External 联系人 Import Live Review 边界
- 第 40 节：目标 36: Email Calendar Signal Live Review 边界
- 第 41 节：目标 37: Business Card Review Live Review 边界
- 第 42 节：目标 38: QR Scan Connect Live Review 边界
- 第 43 节：目标 39: Business Card Scan OCR Live Preview 边界
- 第 44 节：目标 40: App 活动 Detail 路由 Live 服务 Bundle
- 第 45 节：目标 41: App 联系人 Detail 路由 Live 服务 Bundle
- 第 46 节：目标 42: App 联系人 Detail 页面 Live Adapter
- 第 47 节：目标 43: App 活动 Detail 页面 Live Adapter
- 第 48 节：目标 44: API 运行时 模式 边界 Alignment
- 第 49 节：目标 45: 产品 Home Entry Layout Hardening
- 第 50 节：执行 规则

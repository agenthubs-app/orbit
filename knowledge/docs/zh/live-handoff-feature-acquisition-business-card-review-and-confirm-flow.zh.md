# acquisition 能力 Live 交接：business card review and confirm flow
...
| 字段 | 内容 |
| --- | --- |
| 原始来源 | `repos/orbits/features/acquisition/business-card-review-and-confirm-flow/LIVE_IMPLEMENTATION.md` |
| 中文镜像 | `knowledge/docs/zh/live-handoff-feature-acquisition-business-card-review-and-confirm-flow.zh.md` |
...
记录 acquisition 模块中 business card review and confirm flow 能力从 mock-first 实现切换到 live provider 时需要替换和验证的边界。

## 审计依据

已核对对应 feature 目录存在：repos/orbits/features/acquisition/business-card-review-and-confirm-flow。目录级实时行为仍以 service factory、API route 和测试为准。

## 结构化阅读入口

- 第 1 节：Business Card Review 和 Confirm 链路 Live 实现
- 第 2 节：2026-09-07：清空字段的保存与回读
- 第 3 节：2026-09-07：云识别草稿 HTTP 回读交接
- 第 4 节：Live 服务 和 Provider files
- 第 5 节：源标题：Switch mechanism
- 第 6 节：Required env vars 和 权限
- 第 7 节：Privacy 和 provenance constraints
- 第 8 节：Replacement 测试
- 第 9 节：源标题：Live handoff evidence excerpts

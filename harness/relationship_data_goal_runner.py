...
def generate_relationship_mockdata(mockdata_dir: Path, *, minimax_plan_text: str) -> dict[str, int]:
    ...
    signup_event_templates = [
        (
            "関西越境ビジネス交流会",
            "关西跨境商务对接会",
            "Kansai Cross-Border Business Connect",
            "関西を拠点とする越境ビジネス交流会。大阪・京都・神戸の企業が海外パートナーと貿易・投資のつながりを築きます。",
            "立足关西的跨境商务对接会，帮助大阪、京都、神户的企业与海外伙伴建立贸易与投资联系。",
            "A Kansai-based cross-border business connect, helping companies in Osaka, Kyoto and Kobe build trade and investment ties with overseas partners.",
            "Osaka",
            21,
            10,
        ),
        (
            "東京AI実装パートナー交流会",
            "东京 AI 落地伙伴对接会",
            "Tokyo AI Implementation Partner Meetup",
            "AI実装を必要とする企業と、実行できる技術パートナーをつなぐ交流会。ニーズ側と実装側を同じテーブルに置きます。",
            "为需要 AI 落地的企业与能交付的技术伙伴牵线的对接会，把需求方与实施方直接放到一张桌上。",
            "A meetup pairing companies that need AI implementation with technical partners who can deliver, putting demand and delivery at the same table.",
            "Tokyo",
            35,
            14,
        ),
        (
            "日中投資家・創業者サロン",
            "日中投资人与创业者沙龙",
            "Japan-China Investor & Founder Salon",
            "日中の投資家と創業者をつなぐサロン。越境起業と資本連携をテーマに、深い1対1の交流を促します。",
            "连接日中两地投资人与创业者的沙龙，围绕跨境创业与资本合作，促成有深度的一对一交流。",
            "A salon connecting investors and founders across Japan and China, fostering deep one-on-one exchange around cross-border ventures and capital collaboration.",
            "Tokyo",
            49,
            18,
        ),
